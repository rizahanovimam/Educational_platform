...
//------   ЗАМЕТКИ   -----\\   
        ...
        function translateText() {
            ...
            if (!input) { output.innerHTML = 'Введите текст для перевода'; return; }
            let translated = '';
            if (input.toLowerCase().includes('unique_ptr')) translated = 'уникальный указатель';
            else if (input.toLowerCase().includes('raii')) translated = 'захват ресурса при инициализации';
            else translated = `${input} - [Перевод] `;
